        ...
        <div className="event-planner-container">
            ...
            <section className='testimonials'>
                ...
                <div className='testimonial'>
                    <p>
                        "Event Planner made organizing ny wedding a breeze. Highly recommended!"
                    </p>
                ...
                <div className='testimonial'>
                    ...
                    <p className='author'>- Johnson Smith</p>
                </div>
            </section>
